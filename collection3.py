...
for id, course in enumerate(courses_list):
    ...
    durations_dict[key] = durations_dict[key] + [id]

durations_dict = dict(sorted(durations_dict.items()))
print(courses_list)
print(durations_dict)
def get_sorted_dict(durations_dict,courses_list):
    sorted_dict = {}
    for key, values in durations_dict.items():
        for id in values:
            sorted_dict[courses_list[id]["title"]] = key
    return sorted_dict


print(get_sorted_dict(durations_dict,courses_list))